    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary relative items-center justify-center overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute -top-1/4 -left-1/4 h-[600px] w-[600px] rounded-full bg-primary-foreground/20 blur-3xl" />
      ...
      <div className="flex w-full flex-col items-center justify-center px-6 lg:w-1/2">
        ...
        className="w-full max-w-md">
          ...
          <p className="mb-8 text-muted-foreground text-xs">
            {isLogin ? "Acesse sua conta e continue transformando\nsua gestão imobiliária, com a Isafy" : "Cadastre-se e descubra uma nova forma de\ngerenciar, vender e crescer no mercado imobiliário"}
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button 
              type="submit" 
              disabled={loading}
              className="h-12 w-full gradient-primary text-primary-foreground font-semibold text-base shadow-primary hover:opacity-90 transition-opacity">
          ...
          <Button variant="outline" className="h-12 w-full gap-2 text-sm font-medium" onClick={handleGoogleLogin}>
